...
Here left rotated numbers of a number ‘n’ is formed by rotating ‘n’ left 1 to 3 times. For example, 
if n is 2456, then when it is rotated once we get 4562, when it is rotated twice we get 5624 and 
...
Second line should contain the rotated number with the specified factorm
'''
