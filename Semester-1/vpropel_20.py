...
'''Given a number N,  check if it is reverse length divisible. 
...
Note:
It is easy to solve this problem by using strings, but if you want some challenge, 
solve this problem without strings or any library functions.
